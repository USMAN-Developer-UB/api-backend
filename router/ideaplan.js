...
const ideaplan = models.ideaplan;
...
app.get("/", async (req, res) => {
  //ambil data
  // let data = await ideaplan.findAll()
  let data = await ideaplan
    .findAll({
...
app.get("/:id_ideaplan", async (req, res) => {
  // ambil data by id
  let param = { id_ideaplan: req.params.id_ideaplan };
  let data = await ideaplan
    .findOne({ where: param })
    .then((result) => {
      res.json({
...
app.post("/", async (req, res) => {
  ...
  //tampung data
  let data = {
    id_ideaplan: req.body.id_ideaplan,
    nama_ideaplan: req.body.nama_ideaplan,
